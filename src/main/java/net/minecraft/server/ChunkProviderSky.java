...
public class ChunkProviderSky implements IChunkProvider {
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        for (i2 = 0; i2 < 2; ++i2) {
            ...
            GEN_YELLOW_FLOWER.a(this.p, this.j, j2, k2, l2); // Tsunami
        }
        ...
        if (this.j.nextInt(2) == 0) {
            ...
            k2 = l + this.j.nextInt(16) + 8;
            GEN_RED_ROSE.a(this.p, this.j, i2, j2, k2); // Tsunami
        }
        ...
        if (this.j.nextInt(4) == 0) {
            ...
            j2 = this.j.nextInt(128);
            k2 = l + this.j.nextInt(16) + 8;
            GEN_BROWN_MUSHROOM.a(this.p, this.j, i2, j2, k2); // Tsunami
        }
        ...
        if (this.j.nextInt(8) == 0) {
            ...
            j2 = this.j.nextInt(128);
            k2 = l + this.j.nextInt(16) + 8;
            GEN_RED_MUSHROOM.a(this.p, this.j, i2, j2, k2); // Tsunami
        }
        ...
        for (i2 = 0; i2 < 10; ++i2) {
            ...
            k2 = this.j.nextInt(128);
            l2 = l + this.j.nextInt(16) + 8;
            GEN_REED.a(this.p, this.j, j2, k2, l2); // Tsunami
        }
        ...
        if (this.j.nextInt(32) == 0) {
            ...
            j2 = this.j.nextInt(128);
            k2 = l + this.j.nextInt(16) + 8;
            GEN_PUMPKIN.a(this.p, this.j, i2, j2, k2); // Tsunami
        }
        ...
        for (j2 = 0; j2 < i2; ++j2) {
            ...
            GEN_CACTUS.a(this.p, this.j, k2, l2, i3); // Tsunami
        }
        ...
        for (j2 = 0; j2 < 50; ++j2) {
            ...
            i3 = l + this.j.nextInt(16) + 8;
            GEN_WATER.a(this.p, this.j, k2, l2, i3); // Tsunami
        }
        ...
        for (j2 = 0; j2 < 20; ++j2) {
            ...
            i3 = l + this.j.nextInt(16) + 8;
            GEN_LAVA.a(this.p, this.j, k2, l2, i3); // Tsunami
        }
